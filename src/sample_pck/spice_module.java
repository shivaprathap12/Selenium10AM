...
public class spice_module {
	...
	public void flight() throws InterruptedException{
		//Book a flight
				...
				//select flight from 
				new Select(d.findElement(By.id("ControlGroupSearchView_AvailabilitySearchInputSearchVieworiginStation1"))).selectByVisibleText("Hyderabad (HYD)");
				
				//select flight to
				
				new Select(d.findElement(By.id("ControlGroupSearchView_AvailabilitySearchInputSearchViewdestinationStation1"))).selectByVisibleText("Bengaluru (BLR)");
				...
				//select Adults
				new Select(d.findElement(By.id("ControlGroupSearchView_AvailabilitySearchInputSearchView_DropDownListPassengerType_ADT"))).selectByVisibleText("2 Adults");
				
				//select Child
				new Select(d.findElement(By.id("ControlGroupSearchView_AvailabilitySearchInputSearchView_DropDownListPassengerType_CHD"))).selectByVisibleText("1 Child");
	...
	public void close_br() throws InterruptedException {
		Thread.sleep(3000);
		d.quit();
	}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		spice_module ab=new spice_module();
		ab.lauchApp();
		ab.flight();
		ab.close_br();
